...
NetLogo6_0_Path="$1"
javac -d bin/NetLogo6.0/ -cp "./lib/py4j0.10.6.jar:$NetLogo6_0_Path:." src/server/bsearch/space/*.java src/server/bsearch/nlogolink/*.java src/server/*.java src/server/NetLogo6.0/*.java
#provide path to netlogo jar file (include jar file name)
#Compile NetLogo 6.1 server
NetLogo6_1_Path="$2"
javac -d bin/NetLogo6.1/ -cp "./lib/py4j0.10.6.jar:$NetLogo6_1_Path:." src/server/bsearch/space/*.java src/server/bsearch/nlogolink/*.java src/server/*.java src/server/NetLogo6.1/*.java
#Copy over manifests
cp src/server/Manifest.txt bin/NetLogo6.0/
cp src/server/Manifest.txt bin/NetLogo6.1/
#Build jars 
cd "bin/NetLogo6.0/"
